...
pub fn read_constants_bls12381_Fr_n255_t5_alpha5_M128_RF8_RP56() -> Constants<Frbls12_381> {
     ...
     */
    let file =
        File::open("poseidon_params_Frbls12381_n255_t5_alpha5_M128.txt").expect("file not found");
...
pub fn read_constants_bls12381_Fq_n255_t5_alpha5_M128_RF8_RP56() -> Constants<Fqbls12_381> {
     ...
     */
    let file =
        File::open("poseidon_params_Fqbls12381_n255_t5_alpha5_M128.txt").expect("file not found");
    let reader = BufReader::new(file);
